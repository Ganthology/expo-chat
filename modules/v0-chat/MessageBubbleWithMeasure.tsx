...
import { useMessageBlankSize } from './BlankSizeProvider';

interface MessageBubbleProps {
  message: Message;
}

export function MessageBubbleWithMeasure({ message }: MessageBubbleProps) {
  const isUser = message.role === 'user';

  const { onLayout, ref } = useMessageBlankSize(message);
